...
function transformData( pcarsdata ){
	...
	console.log('+++++++++++ transformData() input: ', pcarsdata );
	...
	console.log('+++++++++++ transformData() output: ', retData );
...
//d3.json("/pcars/lib/LapChart/Christoph_2010au.json", function(data) {	
    	...
    	console.log('+++++++++++ LapChart data input: ', data );
    	
    	if (data['lapCount'] >= 10000 || data['lapCount'] <= 0	){    		
    		alert("Number of lapcount unrealistic");
    	}
