...
self.addEventListener('message', function(e) {
	...
	var aDsData = setTimeout(function(){
			...
			var a 	= Receive_DS_data( e.data.dsurl, e.data.dsport , e.data.timeout , e.data.receivemode, e.data.arefpoint, {'originaldatasource': e.data.originaldatasource, 'originalcurgamerunning': e.data.originalcurgamerunning });					
